<?php
Route::group(['prefix' => config('laravel_file_manager.public_route_prefix'), 'namespace' => 'Hamahang\LFM\Controllers', 'middleware' => config('laravel_file_manager.public_middlewares')], function () {
