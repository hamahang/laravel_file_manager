...
function LFM_CreateModalUpload($section, $callback = 'show_upload_file', $options = [], $result_area_id = false, $modal_id = 'UploadFileManager', $header = 'Upload_FileManager', $button_id = 'ShowModalUpload', $button_content = 'Upload', $button_class = 'btn-default', $font_button_class = false, $no_json_encode = false)
{
    ...
    $result['src'] = $src;
    $result['json'] = $no_json_encode ? $json : json_encode($json);
